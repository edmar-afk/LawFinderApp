import safesProfile from "../../assets/img/RA11313Profile.png";import KeyboardBackspaceIcon from "@mui/icons-material/KeyboardBackspace";import { Link } from "react-router-dom";import Description from "./Description";
function Profile() {
	return (
		<>
				...
				<div className="bg-white w-full border-t-4 border-purple-700 border-b-4 rounded-t-2xl px-4 z-50 p-4">
					<div className="flex flex-row">
						...
						<div className="flex flex-col ml-3">
							<p className="font-bold">R.A. 11313 - SAFE SPACES ACT</p>
